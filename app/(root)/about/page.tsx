		...
		<Container>
			<div className="my-12 flex flex-col ">
				<div className="flex w-full items-center justify-center flex-col gap-2">
					<div className="bg-white w-24 h-24 rounded-2xl overflow-hidden">
						<svg
							version="1.0"
...
-51 146 -27 52 -96 79 -148 57z"
					...
					<p>
						...
						vero, hic dolores dolore vel tempora? Molestias vel dolor
						voluptatibus amet iure rerum provident.
					</p>
				</div>
			</div>
		</Container>
